...
namespace Oficina.Dados.Migrations
{
    ...
    [Migration("20211006190409_Estrutura_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modelo.Pessoa.Bairro", b =>
                {
            ...
            modelBuilder.Entity("Modelo.Pessoa.Cidade", b =>
                {
                    b.Property<string>("CodCidade")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("Modelo.Pessoa.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Modelo.Pessoa.Estabelecimento", b =>
                {
            ...
            modelBuilder.Entity("Modelo.Pessoa.Estado", b =>
                {
                    b.Property<string>("UF")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)");
            ...
            modelBuilder.Entity("Modelo.Pessoa.Bairro", b =>
                {
                    b.HasOne("Modelo.Pessoa.Cidade", "cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("Modelo.Pessoa.Cidade", b =>
                {
                    b.HasOne("Modelo.Pessoa.Estado", "estado")
                        .WithMany()
            ...
            modelBuilder.Entity("Modelo.Pessoa.Cliente", b =>
                {
                    b.HasOne("Modelo.Pessoa.Bairro", "bairro")
                        .WithMany()
